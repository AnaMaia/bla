    ...
    <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu"  href="http://localhost/tcc/app/controllers/admin_controller.php?acao=listarAdmin&idAdministrador=<?= $administrador->idAdministrador; ?>"><i class="fa fa-desktop fa-3x"></i>Catálogo Admin</a>
                </li>
                <li>
